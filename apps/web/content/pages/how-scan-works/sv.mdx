...
Vår skanning kombinerar tre kompletterande analysmetoder för att ge er en fullständig bild av er webbplats hälsa. Varje verktyg är specialbyggt för specifika typer av kontroller, och tillsammans täcker de prestanda, SEO, tillgänglighet, integritetsefterlevnad, säkerhet och moderna webbstandarder.
...
**Checklistbaserade kategorier** (prestanda, SEO, juridisk, säkerhet, moderna standarder) använder en fast uppsättning kontroller. Varje kontroll returnerar godkänd, varning eller underkänd, och kategoribetyget är ett viktat genomsnitt.
...
- SEO: 20%
- Tillgänglighet: 20%
- Juridisk efterlevnad: 20%
- Säkerhet: 10%
- Moderna standarder: 10%
