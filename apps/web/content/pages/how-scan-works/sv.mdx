...
description: "Vår kostnadsfria skanning använder Lighthouse, axe-core, HTTP-headeranalys, Google Web Risk och länkkontroll för att granska er webbplats inom sex kategorier. Läs vad varje verktyg gör och hur vi tolkar resultaten."
...
## Fem analysspår, en rapport

Vår skanning kombinerar fem kompletterande analysspår för att ge er en fullständig bild av er webbplats hälsa. Varje spår är specialbyggt för specifika typer av kontroller, och tillsammans täcker de prestanda, SEO, tillgänglighet, förtroende och efterlevnad, säkerhet och webbplatskvalitet.
