...
The scan checks performance alongside five other categories (SEO, accessibility, trust and compliance, security, and website quality), so you see the full picture in a single test. For a broader overview of what the scan covers, see the [free website test](/free-website-test) page.
